...
public class ReviewRepo {
	...
	public ReviewRepo() {
		TacoReview condadoTacos = new TacoReview(1, "Condado", "images/condadoTacos.jpeg",
				...
				+ "They have a simple form that you fill out specifying all the delicious tacos toppings you can think of. "
				+ "Fear not vegetarian/vegan friends, they also have options for you if you aren't feeling carnivorius. "
				+ "Keep in mind that the usual free chips and salsa you get at restaurants is not free at all. Still delicious!");
		...
		TacoReview mimexico = new TacoReview(3, "Mi Mexico", "images/condadoTacos.jpeg", "4.5 out of 5 Tacos",
				...
				+ "think you know what extra hot means until you visit.");
